...
public class PermanentItemEntity extends Entity {
	...
	public void addAdditionalSaveData(CompoundTag compound) {
		...
		if (!this.getItem().isEmpty()) {
			compound.put("Item", this.getItem().save(this.registryAccess(), new CompoundTag()));
		}
	...
	public void readAdditionalSaveData(CompoundTag compound) {
		...
		this.setItem(ItemStack.parseOptional(this.registryAccess(), compoundnbt));
		if (this.getItem().isEmpty()) {
			this.discard();
		}
	...
	public boolean containsSoul() {
		if (this.getItem().is(ModItems.SOUL_CRYSTAL))
			return true;
		else if (this.getItem().is(ModItems.STORAGE_CRYSTAL))
